...
public class Service {
    ...
    public static void main(String[] args) throws IOException, ParseException, InvalidJSONFileException {
        ...
        **/
        ...
        int budget1Phase1 = simulation.runSimulation(rockets1Phase1, DistributionType.LINEAR);
        int budget1Phase2 = simulation.runSimulation(rockets1Phase2, DistributionType.LINEAR);
        ...
        int budget2Phase1 = simulation.runSimulation(rockets2Phase1, DistributionType.LINEAR);
        int budget2Phase2 = simulation.runSimulation(rockets2Phase2, DistributionType.LINEAR);
